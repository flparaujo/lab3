...
public class GradeCurricularTest {
	...
	private LeitorDeDisciplinas leitor;

	@Before
	public void setUp() {
		gradeCurricular = new GradeCurricular();
		leitor =LeitorDeDisciplinas.getInstance();
	}
	...
	public void deveFornecerDisciplina() {
		List<Disciplina> requisito1 = new ArrayList<Disciplina>();
		List<Disciplina> requisito = new ArrayList<Disciplina>();
		Disciplina ic = new Disciplina("Int. à Computação", 4, requisito, 5);
		requisito1.add(ic);
		Disciplina md = new Disciplina("Matemática Discreta", 4, requisito, 5);
		requisito1.add(md);
		Disciplina p1 = new Disciplina("Programação I", 4, requisito, 4);
		Disciplina lp1 = new Disciplina("Lab. de Programação I", 4, requisito, 4);
		List<Disciplina> requisito2 = new ArrayList<Disciplina>();
		requisito2.add(lp1);
		requisito2.add(p1);
		Disciplina tg = new Disciplina("Teoria dos Grafos", 2, requisito2, 3);
		requisito1.add(tg);
		assertEquals(new Disciplina("Teoria da Computacao", 4, requisito1, 6), gradeCurricular.
